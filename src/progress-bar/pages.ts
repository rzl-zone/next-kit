...
import type { ProgressBarPagesComponentProps } from "./types/types";
 ...
 * ```
 */
export const RzlNextPagesProgressBar = React.memo(ProgressBarPagesComponent);

RzlNextPagesProgressBar.displayName = `RzlNextPagesProgressBar(${
  RzlNextPagesProgressBar.displayName ?? RzlNextPagesProgressBar.name ?? "Component"
})`;
