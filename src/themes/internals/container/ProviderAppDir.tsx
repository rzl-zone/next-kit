...
import { isProdEnv, isReactNode } from "@/utils";
import {
  disableAnimation,
  getSystemTheme,
  getTheme,
...
import { minifyInnerHTMLScript, validateProps } from "../helper";
...
export const ContainerThemeAppDir = <EnablingSystem extends boolean = true>(
  ...
  return (
    <InternalAppDirTheme<EnablingSystem> {..._restProps}>{children}</InternalAppDirTheme>
  );
};
...
const ThemeScriptAppDir = memo(
  ...
  }: Omit<RzlThemeProviderProps<EnablingSystem>, "children" | "metaColorSchemeValue"> &
    Required<NonNullable<Pick<RzlThemeProviderProps, "metaColorSchemeValue">>>) => {
        ...
        return (
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: `(${minifyInnerHTMLScript(initialScriptTheme)})(${scriptArgs})`
            }}
          />
        );
      }
